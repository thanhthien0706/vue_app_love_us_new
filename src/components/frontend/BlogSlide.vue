...
<template>
  <div class="box__blog__content backgroundMainItem">
...
export default {
  ...
  methods: {
    ...
    initData() {
      this.dataTab = this.dataBlogSlide
    ...
    getDataListCampaign() {
      this.dataListCampaign = this.dataBlogSlide.filter(
        (item) =>
  ...
  computed: {
    ...mapState(["dataBlogSlide", "statusShowPopup"]),
  },
  watch: {
